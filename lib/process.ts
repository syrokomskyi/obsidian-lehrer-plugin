import { TextBlocks, TableRow } from './types';

export function detectTextBlocks(source: string): TextBlocks {
...
export function transformToDataFrame(blocks: TextBlocks): TableRow[] {
